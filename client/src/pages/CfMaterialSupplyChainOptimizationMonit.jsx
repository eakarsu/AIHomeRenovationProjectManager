...
// Auto-generated page for: Material supply-chain optimization monitoring prices and lea

export default function CfMaterialSupplyChainOptimizationMonit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-material-supply-chain-optimization-monit', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Material supply-chain optimization monitoring prices and lea</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Material supply-chain optimization monitoring prices and lead times for advance purchasing.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Material supply-chain optimization monitoring prices and lea'}
        </button>
      </form>
