...
// Auto-generated page for: No budget optimizer / overspend flagger

export default function GapNoBudgetOptimizerOverspendFlagger() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-budget-optimizer-overspend-flagger', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No budget optimizer / overspend flagger</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No budget optimizer / overspend flagger</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No budget optimizer / overspend flagger'}
        </button>
      </form>
