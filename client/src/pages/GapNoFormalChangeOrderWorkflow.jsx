...
// Auto-generated page for: No formal change-order workflow

export default function GapNoFormalChangeOrderWorkflow() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-formal-change-order-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No formal change-order workflow</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No formal change-order workflow</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No formal change-order workflow'}
        </button>
      </form>
