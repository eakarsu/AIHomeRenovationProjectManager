...
// Auto-generated page for: Lien & payment automation flagging payments at risk of becom

export default function CfLienPaymentAutomationFlaggingPayment() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-lien-payment-automation-flagging-payment', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Lien & payment automation flagging payments at risk of becom</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Lien & payment automation flagging payments at risk of becoming liens.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Lien & payment automation flagging payments at risk of becom'}
        </button>
      </form>
