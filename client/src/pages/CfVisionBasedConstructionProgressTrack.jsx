...
// Auto-generated page for: Vision-based construction progress tracking from daily photo

export default function CfVisionBasedConstructionProgressTrack() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-vision-based-construction-progress-track', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Vision-based construction progress tracking from daily photo</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Vision-based construction progress tracking from daily photo uploads.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Vision-based construction progress tracking from daily photo'}
        </button>
      </form>
