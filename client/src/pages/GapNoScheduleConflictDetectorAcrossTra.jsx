...
// Auto-generated page for: No schedule conflict detector across trades

export default function GapNoScheduleConflictDetectorAcrossTra() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-schedule-conflict-detector-across-tra', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No schedule conflict detector across trades</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No schedule conflict detector across trades</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No schedule conflict detector across trades'}
        </button>
      </form>
