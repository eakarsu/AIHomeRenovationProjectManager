...
// Auto-generated page for: No contractor recommendation engine

export default function GapNoContractorRecommendationEngine() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-contractor-recommendation-engine', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No contractor recommendation engine</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No contractor recommendation engine</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No contractor recommendation engine'}
        </button>
      </form>
