...
// Auto-generated page for: Change-order AI advisor estimating cost/timeline impact and 

export default function CfChangeOrderAiAdvisorEstimatingCostt() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-change-order-ai-advisor-estimating-costt', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Change-order AI advisor estimating cost/timeline impact and </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Change-order AI advisor estimating cost/timeline impact and auto-generating COs.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Change-order AI advisor estimating cost/timeline impact and '}
        </button>
      </form>
