...
// Auto-generated page for: No material cost estimator

export default function GapNoMaterialCostEstimator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-material-cost-estimator', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No material cost estimator</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No material cost estimator</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No material cost estimator'}
        </button>
      </form>
